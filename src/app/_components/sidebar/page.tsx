...
export default function Sidebar() {
  return (
    <div className="p-6 w-1/4 bg-white text-left -ml-0 mr-auto h-screen min-w-max border-r border-gray-D9">
      ...
      <button className="bg-kusumi-pink text-white pt-4 pr-20 pb-4 pl-20 rounded-xl flex text-md mb-6 mx-auto hover:scale-105 hover:duration-300">ログイン</button>
      <button className="bg-kusumi-pink text-white pt-4 pr-20 pb-4 pl-20 rounded-xl flex text-md mb-6 mx-auto hover:scale-105 hover:duration-300">新規登録</button>
    </div>
  );
}
